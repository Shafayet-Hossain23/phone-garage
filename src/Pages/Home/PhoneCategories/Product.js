        ...
        <div className="card  bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    {
                        user ? <label onClick={() => setSelectedProduct(product)} htmlFor="my-modal-3" className="btn btn-primary">Book Now</label> : <Link to="/login"><button className="btn btn-primary">Book Now</button></Link>
                    }
